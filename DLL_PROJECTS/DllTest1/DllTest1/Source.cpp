...
DllExport void citire(int &n, int &m, int mat[500][500], int &tr_l, int &tr_c, int &k, int &Nr_spati_libere_a_lui_Alex)
{
...
DllExport void stergere(int n, int m, int mat[500][500], int tr_l, int tr_c, int &k, int Nr_spati_libere_a_lui_Alex)
{
	int i, j;
...
DllExport void transformare(int n, int m, int mat[500][500], int p)
{
	int i, j;
...
DllExport void afisare(int n, int m, int mat[500][500])
{
	int i, j;
	for (i = 1; i <= n; i++)
	{
